...
class UrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create url" do
    assert_difference("Url.count") do
      post urls_url, params: { url: { url_complete: @url.url_complete, url_short: @url.url_short } }
    end
  ...
  test "should update url" do
    patch url_url(@url), params: { url: { url_complete: @url.url_complete, url_short: @url.url_short } }
